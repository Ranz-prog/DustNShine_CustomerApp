...
public class GeneralCleaningAdapter extends RecyclerView.Adapter<GeneralCleaningAdapter.ViewHolder> {

    List<RecommendationModel> companyList;
    private Context context;
    private GeneralCleaningAdapter.OnClickMessageListener onClickMessageListener;

    public GeneralCleaningAdapter(List<RecommendationModel> companyList, Context context, OnClickMessageListener onClickMessageListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        GeneralCleaningAdapter.ViewHolder viewHolder = new GeneralCleaningAdapter.ViewHolder(view, onClickMessageListener);
