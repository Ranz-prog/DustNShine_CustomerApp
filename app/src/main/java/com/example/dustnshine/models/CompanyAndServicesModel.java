...
public class CompanyAndServicesModel {
    ...
    public CompanyAndServicesModel(int id, String name, String email, String mobile_number, String tel_number, String address, String created_at, String updated_at, String company_image, List<ServicesModel> services) {
        this.id = id;
        this.name = name;
        this.email = email;
