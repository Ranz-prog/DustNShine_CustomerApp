...
public class WorkersModel {
    ...
    public WorkersModel(int id, String first_name, String last_name, String mobile_number, String email, String email_verified_at, String created_at, String updated_at, PivotModel pivot) {
        this.id = id;
